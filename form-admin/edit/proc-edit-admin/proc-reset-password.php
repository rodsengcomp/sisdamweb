    ...
    <div class="row espaco">
        <div class="col-md-12">
            <form class="form-horizontal" style="<?php if ($_SESSION['usuarioNivelAcesso'] > 3) {
                ...
                if ($resetsenha == 'SIM') { ?>
                    <?php $conectar->query("UPDATE usuarios SET status='ATIVO', senha = '2ca28977ca2c7ae97aee1e9af6304d4b2383a9ab', usuarioalt = '$usuariologin', alterado =  NOW(), resetsenha = 'SIM', dataresetsenha = NOW() WHERE id = '$id'");
