            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="text-center">
                        <a href="././admin.php?pag=cad-submenu">
                    ...
                    <table id="Listar_Sisdam" class="table table-hover table-striped table-bordered" cellspacing="0"
                        ...
                        <tr style="<?php if ($_SESSION['usuarioNivelAcesso'] <> 1) {
                            ...
                            <td class="text-center">
                                <a href='././admin.php?pag=edit-submenu&id=<?php echo $row_menus_submenus['id']; ?>'>
                            ...
                            <div class="modal-dialog modal-sm" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <div class="text-center">
                                            <a href='admin.php?pag=del-submenu&id=<?php echo $row_menus_submenus['id']; ?>'>
