...
$listar_pag = "SELECT * FROM pag_admin";
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-title">
                        <h2>
                            Listar Páginas do Painel de Controle
                        </h2>
                        <ol class="breadcrumb">
                            <li><i class="fa fa-dashboard"></i> <a href="admin.php">Painel de Controle</a>
                            </li>
                            <li class="active">Listar Páginas do Painel de Controle</li>
                        </ol>
                    </div>
                    <?php
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="text-center">
                        <a href="././admin.php?pag=cad-pag-admin">
                    ...
                    <table id="Listar_Sisdam" class="table table-hover table-striped table-bordered" cellspacing="0"
                        ...
                        <tr style="<?php if ($_SESSION['usuarioNivelAcesso'] <> 1) {
                            ...
                            <td class="text-center">
                                <a href='././admin.php?pag=edit-pag-admin&id=<?php echo $row_pag['id']; ?>'>
                            ...
                            <div class="modal-dialog modal-sm" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <div class="text-center">
                                            <a href='admin.php?pag=del-pag-admin&id=<?php echo $row_pag['id']; ?>&name_pag=<?php echo $row_pag['name_pag']; ?>&caminho=<?php echo $row_pag['caminho']; ?>'>
