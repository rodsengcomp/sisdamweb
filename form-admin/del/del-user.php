...
if ($conectar->affected_rows != 0) {
    header("Location: admin.php?pag=list-user");
    $_SESSION['msgdel'] = "<div class='alert alert-success text-center'><strong>ID</strong> : $id - <strong>NOME</strong> : $nome - <strong>EMAIL</strong> : $email - <strong>LOGIN</strong> : $login - <strong>APAGADO COM SUCESSO !!!</strong></div>"; ?>

<?php } else {
    $_SESSION['msgdelerro'] = "<div class='alert alert-danger text-center'><strong>ERRO AO APAGAR ID</strong> : $id - <strong>NOME</strong> : $nome - <strong>EMAIL</strong> : $email - <strong>LOGIN</strong> : $login</div>";
    header("Location: admin.php?pag=list-user"); ?>
<?php } ?>
