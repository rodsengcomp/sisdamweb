                    ...
                    <form class="form-horizontal" id="cadastro_menu_submenu" method="POST" action="">
                            ...
                            <div class="col-sm-5">
                                ...
                                <input type="text" id="id_menu" data-toggle="tooltip" title="Ex: 1" class="form-control"
                                       style="<?php if ($_SESSION['usuarioNivelAcesso'] <> 1) {
                                           echo 'display: none;';
                                       } ?>" name="id_menu_sub" placeholder="1" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-5">
                                ...
                                <input type="text" data-toggle="tooltip" title="Digite uma página"
                                       style="<?php if ($_SESSION['usuarioNivelAcesso'] <> 1) {
                                           echo 'display: none;';
                                       } ?>" class="form-control" name="pag" value="suvisjt.php?pag="
                                       placeholder=suvisjt.php?pag=cad-caminho">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-5">
                                ...
                                <a href='././admin.php?pag=list-menu-submenu'
