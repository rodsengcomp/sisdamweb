            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        <li>
                            <i class="fa fa-dashboard"></i> <a href="../../admin.php">Painel de Controle</a>
                        </li>
                        <li class="active">
                            <i class="fa fa-wrench"></i> Icons
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading text-center">
                            <h3><strong>Icones (font-awesome)</strong></h3>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading text-center">
                            <h3><strong>Icones (glyphicon)</strong></h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
