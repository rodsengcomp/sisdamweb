    ...
    <div class="collapse navbar-collapse">
        ...
        if ($menu_principal->rowCount() >= 1):
            ...
            foreach ($menu_principal->fetchAll() as $result_menu_principal):
                ...
                echo '<li>';
                echo '<a class="dropdown-toggle" href="suvisjt.php">' . $result_menu_principal['nome'] . '<span class="caret"></span></a>';
                ...
                if ($submenus->rowCount() >= 1):
                    ...
                    foreach ($submenus->fetchAll() as $submenus_linha):
                        ...
                        echo '<li>';
                        echo '<a class="dropdown-toggle" href="' . $submenus_linha['pag'] . '">' . $submenus_linha['nome'] . '<span class="caret"></span></a>';
                        ...
                        if ($submenus_subs->rowCount() >= 1):
                            ...
                            foreach ($submenus_subs->fetchAll() as $submenus_subs_linha):
                                echo '<li>';
                                echo '<a  class="dropdown-toggle" href="' . $submenus_subs_linha['pag'] . '">' . $submenus_subs_linha['nome'] . '</a>';
                                echo '</li>';
                            endforeach;
                            echo '</ul>';
                        endif;
        ...
        <ul class="nav navbar-nav" style="<?php if ($_SESSION['usuarioNivelAcesso'] == '') {echo 'display: none;';} ?>">
            <li>
        ...
        <ul class="nav navbar-nav">
            <li class="dropdown" style="<?php if ($_SESSION['usuarioNivelAcesso'] == '') {echo 'display: none;';} ?>">
        ...
        <li class="text-center" style="<?php if ($_SESSION['usuarioNivelAcesso'] <> '') {echo 'display: none;';} ?>">
            <a href='index.php'<button type='button' data-toggle="tooltip" title="Acessar Sistema" accesskey="A"
                                       class="btn btn-labeled btn-success m-3"><span class="btn-label"><i class="fa fa-user"></i></span> Login</button></a>
        </li>
    </div>
</nav>
