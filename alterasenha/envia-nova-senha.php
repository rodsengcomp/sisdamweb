...
<div class="container">
    <div class="card card-container">
        ...
        <form id="envianovasenha" class="form-signin">
            ...
            //Corpo da Mensagem
            $mensagem = "Olá <br><br>";
            $mensagem .= "Acesse o link abaixo para alterar a sua senha! <br> <br>";
            ...
            $mensagem .= "Grato - Administrador do Sistema SisdamWeb";
            ...
            if ($Mailer->Send()) {
                if ($sql->num_rows > 0) { ?>
                    ...
                    <button type='button' class="btn btn-lg btn-primary btn-block btn-signin" data-toggle="tooltip"
                            data-placement="right" title="Entrar no Sistema SisdamJT">Voltar
                    </button></a>
