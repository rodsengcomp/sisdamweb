...
<!-- Jumbotron principal de uma mensagem de marketing primário ou chamada à ação -->
<div class="jumbotron">
    <div class="container">
        <div class="text-center">
            <h2><strong>Olá, <?php echo $usuarionome ?> !!!</strong></h2></br>
        </div>
        <p><strong>Este é um Sistema desenvolvido por colaboradores da Suvis Jaçanã-Tremembé. Ele inclui muitas horas de
                ...
                agilizar e melhorar o serviço publico com qualidade e dedicação.</strong></p>
        <!--<p><a class="btn btn-primary btn-lg" href="saibamais.php" role="button">Saiba mais &raquo;</a></p>-->
    </div>
</div>
