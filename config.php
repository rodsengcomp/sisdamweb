...
$pdo = new PDO('mysql:host=10.47.171.69;dbname=sisdam', 'sisdam_bdjacana', '3f2nY4es3UdxGA7P', array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));

class config
{
    var $hostclass = '10.47.171.69';
