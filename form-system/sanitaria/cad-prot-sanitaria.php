        ...
        <div class="col-md-12">
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Cadastrar Documento <?php echo $today = date("Y");   ?> </li>
                </ol>
                <button type="button" class="btn btn-success btn-lg btn-block">CADASTRO SANITÁRIA- <?php echo $today = date("Y");   ?> </button>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" data-toggle="tooltip" title="Digite o Nº do Documento" maxlength="20" name="ndoc" placeholder="0000-0.000.000-1" autofocus>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" data-toggle="tooltip"
                               ...
                               placeholder="000/<?php echo date('y')?>">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-11">
                        <textarea class="form-control" rows="2" data-toggle="tooltip" data-placement="top" title=""
                                  name="observacao" placeholder="DESCREVA A OBSERVAÇÃO" onchange="upperCaseF(this)"></textarea>
                    </div>
                </div>
