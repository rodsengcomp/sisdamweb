        ...
        <div class="col-md-12">
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Sv2 Surto <?php echo $today = date("Y");   ?> </li>
                </ol>
                <button type="button" class="btn btn-primary btn-lg btn-block">CADASTRO SV2 - SURTO <?php echo $today = date("Y");   ?> </button>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <fieldset <?php if ($_SESSION['usuarioNivelAcesso'] == "") {
                ...
                <form class="form-horizontal" id="cadastro_sv2_surto" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" data-toggle="tooltip"
                                   title="O sinan deve ter 7 numeros" required name="sinan" id="sinancad" size="7"
                                   maxlength="7" placeholder="0000000" value="<?php echo $sinan ?>" autofocus>
                        </div>
                    ...
                    <div class="form-group">
                        <label for="inputAgravoSurto" class="col-sm-1 control-label">AGRAVO</label>
                        <div class="col-sm-5">
