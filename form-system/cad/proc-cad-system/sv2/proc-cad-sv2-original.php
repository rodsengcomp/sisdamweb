...
$idrua = mysqli_real_escape_string($conectar, $_POST["idrua"]);
    ...
    $sql_sv2_suvis = $conectar->query("SELECT id FROM sv2 WHERE sinan='$sinan' AND agravo='$agravo' AND nome='$nome' AND datanot='$datanot' AND agravo<>'TUBERCULOSE'");

if ($sql_tuberculose->num_rows > 0) {
    include_once 'form-sv2-edit.php';
    } elseif ($sql_sv2_suvis->num_rows > 0) {
        include_once 'form-sv2-edit.php';
            } elseif ($tipo == 'outros') {if (!$conectar->query("INSERT INTO sv2 (sinan,datanot,agravo,ocorrencia,nome,idade,sexo,dataentrada,se,localate,rua,num,comp,tel,cep,log,cidade,bairro,localvd,suvis,dataobito,latsv2,longsv2,da,usuariocad,criado,tipo,idrua) VALUES ('$sinan', '$datanot', '$agravo', '$ocorrencia', '$nome', '$idade', '$sexo', '$dataentrada','$se','$localate', '$ruaoutros', '$num', '$comp', '$tel', '$cep', '$log', '$cidade', '$bairro', '$localvd', '$suvis', '$dataobito' , '$latsv2' , '$longsv2' , '$da', '$usuariologin', NOW(), '$tipo','$idrua')")) die ('<br><br><div class="container theme-showcase" role="main" xmlns="http://www.w3.org/1999/html"><div class="row"><div class="col-md-12"><div class="form-group"><a href="javascript:history.back()" <button type=\'button\' class=\'btn btn-danger\' accesskey="V"><span class="glyphicon glyphicon-arrow-left"></span> <u>V</u>OLTAR</button></a><h4><strong><div class="alert alert-danger text-center" role="alert">ERROR:02 FALHA DE SICRONIZAÇÃO COM A TABELA !!! SE PERSISTIR CONTATE: sisdamjt@gmail.com</h4></strong></div></div></div>');
                include_once 'form-sv2-insert.php';
        } elseif ($tipo == 'siva-outros') {if (!$conectar->query("INSERT INTO sv2 (sinan,datanot,agravo,ocorrencia,nome,idade,sexo,dataentrada,se,localate,rua,num,comp,tel,cep,log,cidade,bairro,localvd,suvis,dataobito,latsv2,longsv2,da,usuariocad,criado,tipo,idrua) VALUES ('$sinan', '$datanot', '$agravo', '$ocorrencia', '$nome', '$idade', '$sexo', '$dataentrada','$se','$localate', '$ruaoutros', '$num', '$comp', '$tel', '$cep', '$log', '$cidade', '$bairro', '$localvd', '$suvis', '$dataobito' , '$latsv2' , '$longsv2' , '$da', '$usuariologin', NOW(), '$tipo','$idrua')")) die ('<br><br><div class="container theme-showcase" role="main" xmlns="http://www.w3.org/1999/html"><div class="row"><div class="col-md-12"><div class="form-group"><a href="javascript:history.back()" <button type=\'button\' class=\'btn btn-danger\' accesskey="V"><span class="glyphicon glyphicon-arrow-left"></span> <u>V</u>OLTAR</button></a><h4><strong><div class="alert alert-danger text-center" role="alert">ERROR:02 FALHA DE SICRONIZAÇÃO COM A TABELA !!! SE PERSISTIR CONTATE: sisdamjt@gmail.com</h4></strong></div></div></div>');
            include_once 'form-sv2-insert.php';
    } else {if (!$conectar->query("INSERT INTO sv2 (sinan,datanot,agravo,ocorrencia,nome,idade,sexo,dataentrada,se,localate,rua,num,comp,tel,cep,log,cidade,bairro,localvd,suvis,dataobito,latsv2,longsv2,da,usuariocad,criado,tipo,idrua) VALUES ('$sinan', '$datanot', '$agravo', '$ocorrencia', '$nome', '$idade', '$sexo', '$dataentrada','$se','$localate', '$rua', '$num', '$comp', '$tel', '$cep', '$log', '$cidade', '$bairro', '$localvd', '$suvis', '$dataobito' , '$latsv2' , '$longsv2' , '$da', '$usuariologin', NOW(), '$tipo','$idrua')")) die ('<br><br><div class="container theme-showcase" role="main" xmlns="http://www.w3.org/1999/html"><div class="row"><div class="col-md-12"><div class="form-group"><a href="javascript:history.back()" <button type=\'button\' class=\'btn btn-danger\' accesskey="V"><span class="glyphicon glyphicon-arrow-left"></span> <u>V</u>OLTAR</button></a><h4><strong><div class="alert alert-danger text-center" role="alert">ERROR:02 FALHA DE SICRONIZAÇÃO COM A TABELA !!! SE PERSISTIR CONTATE: sisdamjt@gmail.com</h4></strong></div></div></div>');
        include_once 'form-sv2-insert.php';}
?>
