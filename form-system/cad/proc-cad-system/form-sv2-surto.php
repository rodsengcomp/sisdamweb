<fieldset disabled>
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <input type="text" class="form-control" name="sinan" value="<?php echo $sinan ?>">
        </div>

        <label for="inputDataNot" class="col-sm-2 control-label">NOTIFICAÇÃO</label>
        <div class="col-sm-2">
            <input type="text" class="form-control" name="datanot" value="<?php echo $datanot ?>">
        </div>


        <label for="inputDataEntrada" class="col-sm-1 control-label">ENTRADA</label>
        <div class="col-sm-2">
            <input type="text" class="form-control" name="dataentrada" value="<?php echo $dataentrada ?>">
        </div>

        <label for="inputSe" class="col-sm-1 control-label">SE</label>
        <div class="col-sm-1">
            <input type="text" class="form-control" name="se" value="<?php echo $se ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <input type="text" class="form-control doencanot" name="doencanot" value="<?php echo $doencanot ?>">
        </div>

        <label for="inputLocalAte" class="col-sm-1 control-label">ATENDIDO</label>
        <div class="col-sm-5">
            <input type="text" class="form-control localate" name="localate" value="<?php echo $localate ?>">
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control ocorrencia" name="ocorrencia" value="<?php echo $ocorrencia ?>">
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <input type="text" class="form-control rua" name="rua" value="<?php echo $rua ?>">
        </div>
        ...
        <div class="col-sm-2">
            <input type="text" class="form-control" name="comp" value="<?php echo $comp ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" class="form-control" name="log" value="<?php echo $log ?>">
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" name="localvd" value="<?php echo $localvd ?>">
        </div>

        <label for="inputAtual" class="col-sm-1 control-label">ATUAL?</label>
        <div class="col-sm-1">
            <input type="text" class="form-control" name="suvis" value="<?php echo $atual ?>">
        </div>

        <label for="inputSuvis" class="col-sm-1 control-label">SUVIS</label>
        <div class="col-sm-4">
            <input type="text" class="form-control" name="suvis" value="<?php echo $suvis ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <input type="text" class="form-control" name="dataobito" value="<?php echo $dataobito ?>">
        </div>
