...
if ($agravo_buttons == 'dengue') {$consulta_sinan = "SELECT tbldengue.UnidadeNotificadora, tbldengue.DataEntrada, tbldengue.nDoc, tblDengue.Endereco1, tblDengue.N, 
...
<br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-lg-4">
                            <h5><p><strong>TR: <?php if ($resultado_tr == "") {echo "Exame Não Realizado";} else { echo $resultado_tr;} ?>&nbsp;</strong></p></h5></p>
                        </div><!--/.col-xs-6.col-lg-4-->
                        <div class="col-xs-6 col-lg-4">
