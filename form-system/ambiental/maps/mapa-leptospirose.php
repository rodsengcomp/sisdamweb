...
<script>
    ...
    function initMap() {
        var map = new google.maps.Map(document.getElementById('maplepto'), {
        ...
        downloadUrl('form-system/ambiental/list/proc-list-ambiental/proc-maps-lepto.php', function(data) {
