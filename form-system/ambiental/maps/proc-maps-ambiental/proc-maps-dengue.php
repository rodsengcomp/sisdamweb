...
resultado_ccz.Resultado_IgM_Focus, resultado_ccz.Coleta,resultado_ccz.Resultado_IgM_Panbio,resultado_ccz.Resultado_NS1,resultado_ccz.LIBERACAO_EM,
...
while ($row_markers = mysqli_fetch_assoc($resultado_markers)) {
    ...
    echo 'dtres="'. $row_markers['LIBERACAO_EM'].'" ';
