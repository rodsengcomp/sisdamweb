...
<script>
    ...
    function initMap() {
        var map = new google.maps.Map(document.getElementById('mapfebre'), {
        ...
        downloadUrl('form-system/ambiental/list/proc-list-ambiental/proc-maps-febre.php', function(data) {
