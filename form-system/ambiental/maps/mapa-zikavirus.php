...
<script>
    ...
    function initMap() {
        var map = new google.maps.Map(document.getElementById('mapzika'), {
        ...
        downloadUrl('form-system/ambiental/list/proc-list-ambiental/proc-maps-zika.php', function(data) {
