...
$table = <<<EOT
 ( 
SELECT esporo_an_ent_medc.id_esp_ent, esporo_an_ent_medc.nm_esp_medc, esporo_an_ent_medc.dsg_esp_medc, 
...
$columns = array(
                ...
                array('db' => 'nm_mdc_esp_an', 'dt' => 1),
                array('db' => 'dsg_esp_medc', 'dt' => 2),
                array('db' => 'qtd_esp_medc', 'dt' => 3),
                array('db' => 'nome', 'dt' => 4, 'formatter' => function ($d) {
                    return strstr($d, ' ', true);;
                }),
                array('db' => 'dt_criado', 'dt' => 5, 'formatter' => function ($d) {
                    switch($d){
                        case '';
                            return '';
                            break;
