...
$table = <<<EOT
 (
    ...
    chiku_ial.Resultado, chiku_ial.Paciente, chiku_ial.Exame
...
$columns = array(
    ...
    array( 'db' => 'DT_SIN_PRI', 'dt' => 2),
    array( 'db' => 'NM_PACIENT', 'dt' => 3),
    array( 'db' => 'DT_NASC', 'dt' => 4),
    array( 'db' => 'ID_CNS_SUS', 'dt' => 5),
    array( 'db' => 'NM_MAE_PAC', 'dt' => 6),
    array( 'db' => 'Endereco1', 'dt' => 7),
    array( 'db' => 'NU_NUMERO', 'dt' => 8),
    array( 'db' => 'NM_COMPLEM', 'dt' => 9),
    array( 'db' => 'UBS1', 'dt' => 10),
    array( 'db' => 'NU_TELEFON', 'dt' => 11),
    array( 'db' => 'Resultado', 'dt' => 12),
    array( 'db' => 'Exame', 'dt' => 13),
    array( 'db' => 'UnidadeNotificadora', 'dt' => 14),
    array( 'db' => 'DS_OBS', 'dt' => 15),
    array( 'db' => 'CLASSI_FIN', 'dt' => 16),
    array( 'db' => 'CRITERIO', 'dt' => 17),
    array( 'db' => 'DT_ENCERRA', 'dt' => 18)
);
