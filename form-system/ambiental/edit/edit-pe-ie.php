...
$consulta_pe_ie = "SELECT * FROM pes_ies_38_83 WHERE id_pe_ie='$id'";
        ...
        <div class="col-md-12">
            <div class="page-header">
                ...
                <button type="button" class="btn btn-warning btn-labeled btn-lg btn-block"><span class="btn-label"><i
                            class="glyphicon glyphicon-pencil"></i></span>EDITAR PE / IE <?php echo $today = date("Y"); ?></button>
            </div>
        </div>
    </div>
                ...
                <form class="form-horizontal" id="edit-pe-ie" method="POST" action="suvisjt.php?pag=proc-pe-ie">
                    ...
                    <div class="form-group" id="apresentacao">
                        <input id="ruagoogle1" style="margin-top: 10px;" class="form-control" type="text"
                               name="ruagoogle1" value="<?php echo $editar_pe_ie['ruagoogle_pe_ie']; ?>" placeholder="Digite o local">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <select autofocus data-toggle="tooltip" data-placement="top" title="PE ou IE"
                                ...
                                <option value="1" <?php if ($editar_pe_ie['risco_pe_ie'] == NULL) { echo 'selected'; } ?> >???</option>
                                <option value="1" <?php if ($editar_pe_ie['risco_pe_ie'] == 0) { echo 'selected'; } ?> >???</option>
                                <option value="1" <?php if ($editar_pe_ie['risco_pe_ie'] == 1) { echo 'selected'; } ?> >GRAVE</option>
                                <option value="2" <?php if ($editar_pe_ie['risco_pe_ie'] == 2) { echo 'selected'; } ?> >MÉDIO</option>
                                <option value="3" <?php if ($editar_pe_ie['risco_pe_ie'] == 3) { echo 'selected'; } ?> >FRACO</option>
                                <option value="4" <?php if ($editar_pe_ie['risco_pe_ie'] == 4) { echo 'selected'; } ?> >DESAT.</option>
                            </select>
                        </div>
                    ...
                    <input type="hidden" name="formulario" value="EDICAO">
