    ...
    <div class="row">
        <div class="col-md-12">
            <fieldset <?php if ($_SESSION['usuarioNivelAcesso'] == "") {
                ...
                <form class="form-horizontal" id="edit-end" method="POST" action="suvisjt.php?pag=proc-edit-end">
                    ...
                    <div class="form-group text-center">
                        ...
                        <a href='suvisjt.php?pag=list-end' role="button" type='button' accesskey="L" class="btn btn-labeled btn-info"><span class="btn-label"><i
