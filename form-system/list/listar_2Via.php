...
$result_sinan_imprimir1via = "SELECT * FROM dengue WHERE Impressao = 'FALSO'";
...
<div class="container-fluid" role="main" xmlns="http://www.w3.org/1999/html">
    <div class="page-header text-center">
        <h3><strong>IMPRESSÃO -<span class="verm"> BLOQUEIO 2ª VIA </span> - SISDAMJT WEB</strong></h3>
    </div>

    <div class="row espaco">
        <div class="text-center">
            <a href='formulario.php?link=60&id=<?php echo $row_rua_nomes['id']; ?>'>
                <button type='button' style="<?php if ($_SESSION['usuarioNivelAcesso'] == 4) {
                    echo 'display: none;';
                } ?>" accesskey="I" class="btn btn-default"><span class="glyphicon glyphicon-print"><strong></span>
                    <u>I</u>MPRIMIR</strong></button>
            </a>
        </div>
    </div>
    ...
    <table id="Listar_Sisdam" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <td class="text-center"><?php echo utf8_encode($row_sinan_imprimir1via["imprimir1viaolicitante"]); ?></td>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="text-center">
                                <a href='formulario.php?link=4&id=<?php echo $row_sinan_imprimir1via['id']; ?>'>
                                    <button type='button' style="<?php if ($_SESSION['usuarioNivelAcesso'] == 4) {
                                        echo 'display: none;';
                                    } ?>" class="btn btn-success"><span class="glyphicon glyphicon-pencil">SUVIS
                                    </button>
                                </a>&nbsp;&nbsp;&nbsp;
                                <a href='formulario.php?link=9&id=<?php echo $row_sinan_imprimir1via['id']; ?>'>
                                    <button type='button' style="<?php if ($_SESSION['usuarioNivelAcesso'] == 4) {
                                        echo 'display: none;';
                                    } ?>" class='btn btn-warning'><span class="glyphicon glyphicon-pencil">OUTRO
                                    </button>
                                </a>&nbsp;&nbsp;&nbsp;
                                <button type="button" data-dismiss="modal" class="btn btn-danger"><span
