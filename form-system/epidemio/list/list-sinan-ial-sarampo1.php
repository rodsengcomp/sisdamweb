...
<div class="container-fluid" role="main" xmlns="http://www.w3.org/1999/html">
    ...
    include_once 'form-system/epidemio/maps/proc-maps-epidemio/proc-maps-sarampo-count.php';
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#list-sinan-ial-sarampo').DataTable({responsive: {details: {display: $.fn.dataTable.Responsive.display.modal({header: function (row) {var data = row.data();
                ...
                dom: "lBfrtip",processing: true, serverside: true, ajax: 'form-system/epidemio/list/proc-list-epidemio/list-sinan-ial-sarampo.php',
                ...
                "aoColumnDefs": [
                    ...
                    //}
                    {
                        ...
                        "mRender": function (data, type, full) { //aqui é uma funçãozinha para pegar os ids
                            return '<a target="_blank" href="https://www.google.com.br/maps/dir/?api=1&origin=R. Maria Amália Lopes Azevedo, 3676 - Vila Albertina&destination=' + full[24] + '&travelmode=driving" role="button" class="btn btn-default rounded-circle"><img src="imagens/maps_64dp.png" width="20"></a>';
                        }
                    },
                   ...
                   /* {
                        "aTargets": [4], // o numero é o nº da coluna
                        "mRender": function (data, type, full) { //aqui é uma funçãozinha para pegar os ids
                            var ialgal = full[4];
                            switch (ialgal) {
                                case ' \r':
                                    ialgal = '<a target="_blank" href="https://gal.saude.sp.gov.br/gal/bmh/consulta-paciente-laboratorio/imprimir-resultado/?requisicoes=[%22'+ full [1] +'%22]">'+full[4]+'</a>';
                                    break;
                                case 'Reagente ':
                                    ialgal = '<a target="_blank" href="https://gal.saude.sp.gov.br/gal/bmh/consulta-paciente-laboratorio/imprimir-resultado/?requisicoes=[%22'+ full [1] +'%22]">'+full[4]+'</a>';
                                    break;
                                ...
                                case 'Indeterminado ':
                                    ialgal = '<a target="_blank" href="https://gal.saude.sp.gov.br/gal/bmh/consulta-paciente-laboratorio/imprimir-resultado/?requisicoes=[%22'+ full [1] +'%22]">'+full[4]+'</a>';
                                    break;
                                default: ialgal = '<a target="_blank" href="https://gal.saude.sp.gov.br/gal/bmh/consulta-paciente-laboratorio/imprimir-resultado/?requisicoes=[%22'+ full [1] +'%22]" title="Desativado" >Sem Coleta</a>';
                            }
                            return ialgal;
                        }
                    },
                    */
                    ...
                    {"aTargets": [27], // o numero 6 é o nº da coluna
                        "mRender": function (data, type, full) { //aqui é uma funçãozinha para pegar os ids
        ...
        <div class="col-md-12">
            <div class="page-header">
                ...
                <div class="alert alert-danger text-center" style="<?php if($sql_button_at_end->num_rows < 1) {echo 'display: none;';} ?>" role="alert"><i class="glyphicon glyphicon-exclamation-sign"></i>
                    <strong>ATENÇÃO !!! </strong><a href="http://10.47.171.110/sisdamweb/suvisjt.php?pag=edit-end-epidemio&pagina=1&sinan=exantnet&tabela=tblsarampo&buttons=sarampo&agravo=SARAMPO&ial=sarampo_ial&list=sarampo" class="alert-link">Clique aqui</a>. <strong>EXISTEM NOVOS CASOS PARA ATUALIZAR !!!</strong>.
                </div>
    ...
    <table id="list-sinan-ial-sarampo" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
     ...
     <!--   <th class="text-center"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></th> <!-- 14 -->
            ...
            <!--  <th class="text-center"><span class="glyphicon glyphicon-trash" aria-hidden="true"></th> <!-- 13 -->
