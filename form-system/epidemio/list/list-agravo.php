...
<div class="container-fluid" role="main" xmlns="http://www.w3.org/1999/html">
    ...
    <table id="list-agravo" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
        <thead>
        <tr>
            <th>ID</th>
