...
<div class="container-fluid" role="main" xmlns="http://www.w3.org/1999/html">
    ...
    $result_coque = "SELECT coquenet.NU_NOTIFIC, coquenet.NM_PACIENT, coquenet.DT_SIN_PRI, coquenet.DT_NASC, coquenet.DT_NOTIFIC,
        ...
        <div class="col-md-12">
            <div class="page-header">
                ...
                <button type="button" class="btn btn-danger btn-labeled btn-lg btn-block"><span class="btn-label"><i
                    class="glyphicon glyphicon-list"></i></span> SINAN - IAL COQUELUCHE</button>
            </div>
        </div>
    </div>
    <!-- /.row -->
