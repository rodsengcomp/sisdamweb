        ...
        <div class="col-md-12">
            ...
            <div class="tab-content">
                <div class="tab-pane fade in active" id="resumo">
                    ...
                    <table id="rel-sarampo-ial" class="table table-hover table-striped table-bordered" cellspacing="0" style="width: 100%">
                        <thead>
                        <tr>
                            ...
                            <th class="text-center" style="font-weight: bold;background-color: #b52b27;color: white">POSITIVO</th>
                            <th class="text-center" style="font-weight: bold;background-color: #4cae4c;color: white">NEGATIVO</th>
                            <th class="text-center" style="font-weight: bold;background-color: #e0a800;color: white">INCONCLUSIVO</th>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($pos_ubs_albertina) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($neg_ubs_albertina) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($em_ana_ubs_albertina) as $row) {echo $row[$count_ndoc];}?> </td>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($pos_ubs_apuana) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($neg_ubs_apuana) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($em_ana_ubs_apuana) as $row) {echo $row[$count_ndoc];}?> </td>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($pos_ubs_edu) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($neg_ubs_edu) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($em_ana_ubs_edu) as $row) {echo $row[$count_ndoc];}?> </td>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($pos_ubs_flor) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($neg_ubs_flor) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($em_ana_ubs_flor) as $row) {echo $row[$count_ndoc];}?> </td>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($pos_ubs_fontalis) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($neg_ubs_fontalis) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($em_ana_ubs_fontalis) as $row) {echo $row[$count_ndoc];}?> </td>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($pos_ubs_galvao) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($neg_ubs_galvao) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($em_ana_ubs_galvao) as $row) {echo $row[$count_ndoc];}?> </td>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($pos_ubs_joamar) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($neg_ubs_joamar) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($em_ana_ubs_joamar) as $row) {echo $row[$count_ndoc];}?> </td>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($pos_ubs_pedras) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($neg_ubs_pedras) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($em_ana_ubs_pedras) as $row) {echo $row[$count_ndoc];}?> </td>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($pos_ubs_jacana) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($neg_ubs_jacana) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($em_ana_ubs_jacana) as $row) {echo $row[$count_ndoc];}?> </td>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($pos_ubs_mariquinha) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($neg_ubs_mariquinha) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($em_ana_ubs_mariquinha) as $row) {echo $row[$count_ndoc];}?> </td>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($pos_ubs_toledo) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($neg_ubs_toledo) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold"> <?php foreach($conectar->query($em_ana_ubs_toledo) as $row) {echo $row[$count_ndoc];}?> </td>
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="font-weight: bold;background-color: #9d9d9d;color: black"> <?php foreach($conectar->query($pos_total) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold;background-color: #9d9d9d;color: black"> <?php foreach($conectar->query($neg_total) as $row) {echo $row[$count_ndoc];}?> </td>
                            <td class="text-center" style="font-weight: bold;background-color: #9d9d9d;color: black"> <?php foreach($conectar->query($em_ana_total) as $row) {echo $row[$count_ndoc];}?> </td>
                ...
                <div class="tab-pane fade" id="lista">
                    ...
                    <table id="list-rel-sarampo" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                        <tr>
