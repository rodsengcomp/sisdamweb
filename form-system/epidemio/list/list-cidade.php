<div class="container-fluid" role="main" xmlns="http://www.w3.org/1999/html">
        ...
        <div class="col-md-12">
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Cidades Brasileiras</li>
                </ol>
                <button type="button" class="btn btn-default btn-labeled btn-lg btn-block"><span class="btn-label"><i
                                class="glyphicon glyphicon-list"></i></span>LISTA DE CIDADES BRASILEIRAS</button>
            </div>
            <?php
    ...
    <table id="list-cidade" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
        <thead>
        <tr>
            <th>ID</th>
