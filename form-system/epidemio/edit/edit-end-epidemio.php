...
include_once 'sql-edit-end-epidemio.php';
...
while($rows_edit_end = mysqli_fetch_assoc($resultado_edit_end)){?>
    ...
    <div class="container theme-showcase" role="main" xmlns="http://www.w3.org/1999/html">
        ...
        <script type="text/javascript">
            function initialize() {
                var latlng = new google.maps.LatLng(-23.456077,-46.591556);
                ...
                autocomplete.addListener('place_changed', function() {
                    ...
                    if (!place.geometry) {
                        window.alert("O local retornado pelo preenchimento automático não contém Geolocalização !!!");
                        return;
                    }
        ...
        <div class="row">
            ...
            <div class="col-md-12"><fieldset <?php if ($_SESSION['usuarioNivelAcesso'] == "") {echo 'disable';} ?>>
                    ...
                    <form class="form-horizontal" id="edit_end_epidemio" method="POST" action="suvisjt.php?pag=proc-edit-end-epidemio">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-11"><input id="obs" readonly data-toggle="tooltip" title="Preenchimento Automatico"
                        ...
                        <div class="form-group text-center">
                            <div class="col-md-12">
                                ...
                                <a href='suvisjt.php?pag=list-sinan-ial-<?php if ($agravo_buttons == 'sarampo') echo 'sarampo';
                ...
                <nav class="text-center"><ul class="pagination">
                        <li><?php if($pagina_anterior != 0){ ?><a data-toggle="tooltip" title="Anterior" href="suvisjt.php?pag=edit-end-epidemio&pagina=<?php echo $pagina_anterior; ?>&sinan=<?php echo $agravo_sinan_sql ;?>&tabela=<?php echo $agravo_tabela_sql ;?>&buttons=<?php echo $agravo_buttons ;?>&agravo=<?php echo $agravo_hidden;?>&ial=<?php echo $agravo_ial;?>"
                        ...
                        <?php /*Apresentar a paginacao*/for($i = 1; $i < $num_pagina + 1; $i++){ ?>
                            <li><a data-toggle="tooltip" title="Registro <?php echo $i;?>" href="suvisjt.php?pag=edit-end-epidemio&pagina=<?php echo $i; ?>&sinan=<?php echo $agravo_sinan_sql ;?>&tabela=<?php echo $agravo_tabela_sql ;?>&buttons=<?php echo $agravo_buttons ;?>&agravo=<?php echo $agravo_hidden;?>&ial=<?php echo $agravo_ial;?>"><?php echo $i; ?></a></li>
                        <?php } ?>
                        <li><?php if($pagina_posterior <= $num_pagina){ ?><a data-toggle="tooltip" title="Próxima" href="suvisjt.php?pag=edit-end-epidemio&pagina=<?php echo $pagina_posterior;?>&sinan=<?php echo $agravo_sinan_sql ;?>&tabela=<?php echo $agravo_tabela_sql ;?>&buttons=<?php echo $agravo_buttons ;?>&agravo=<?php echo $agravo_hidden;?>&ial=<?php echo $agravo_ial;?>" aria-label="Previous">
