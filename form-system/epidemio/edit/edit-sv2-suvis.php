    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-header">
                ...
                <button type="button" class="btn btn-success btn-lg btn-block">EDITAR SV2 - SUVIS - <?php if($year == 'atual'): echo date('Y');else:echo $year;endif;?></button>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <fieldset <?php if ($_SESSION['usuarioNivelAcesso'] == "") {
                ...
                <form class="form-horizontal" id="edicao_sv2" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="number" tabindex="2" class="form-control" data-toggle="tooltip"
                                   ...
                                   value="<?php echo $editar_sinan_suvis['protocolo']; ?>">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control agravo" data-toggle="tooltip"
                                   ...
                                   value="<?php echo $editar_sinan_suvis['agravo']; ?>">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"><input type="text" id="da" readonly  data-toggle="tooltip" title="Preenchimento Automatico" maxlength="2"
                                                     class="form-control" name="da" placeholder="00" value="<?php echo $editar_sinan_suvis['da']; ?>"></div>
                        ...
                        <input type="hidden" name="latitude" id="latitude" value="<?php echo $editar_sinan_suvis['latsv2']; ?>">
                        <input type="hidden" name="longitude" id="longitude" value="<?php echo $editar_sinan_suvis['longsv2']; ?>">
                        <input type="hidden" name="idrua" value="<?php echo $editar_sinan_suvis['idrua']; ?>">
                    ...
                    <div class="form-group text-center">
                        ...
                        <a href='suvisjt.php?pag=edit-sv2-outros&id=<?=$editar_sinan_suvis['id'].$edit;?>'>
                            <button accesskey="O" type="button" style="<?php if ($_SESSION['usuarioNivelAcesso'] == 0) {
                                echo 'display: none;';
                            } ?>" data-toggle="tooltip" title="SV2 OUTROS" class="btn btn-labeled btn-danger"><span
                                        class="btn-label"><i class="glyphicon glyphicon-pencil"></i></span><u>O</u>UTROS
                            </button>
                        </a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href='suvisjt.php?pag=edit-sv2-siva&id=<?=$editar_sinan_suvis['id'].$edit;?>'>
                        ...
                        <a href='suvisjt.php?pag=edit-sv2-surto&id=<?=$editar_sinan_suvis['id'].$edit;?>'>
                        ...
                        <button type="button" accesskey="A" class='btn btn-danger'
                                ...
                                data-target="#myModal<?php echo $editar_sinan_suvis['id']; ?>"><span
                                    class="glyphicon glyphicon-trash"></span></button>
                    </div>

                    <!-- Inicio Modal Deletar-->
                    <div class="modal fade" id="myModal<?php echo $editar_sinan_suvis['id']; ?>" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-sm" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="text-center">
                                            ...
                                            <button type="button"
                                                    class="btn btn-danger btn-lg btn-block"><?php echo $editar_sinan_suvis['sinan'] ?></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-footer">
                                    <div class="text-center">
                                        <a href='suvisjt.php?pag=del-sisdamweb&id=<?php echo $editar_sinan_suvis['id']; ?>&sinan=<?php echo $editar_sinan_suvis['sinan']; ?>&agravo=<?php echo $editar_sinan_suvis['agravo']; ?>&nome=<?=$editar_sinan_suvis['nome'].'&form=sv2'.$edit;?>'>
