    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-header">
                ...
                <button type="button" class="btn btn-success btn-lg btn-block">EDITAR SV2 - SUVIS</button>
            </div>
        </div>
    </div>
                        ...
                        <div class="modal-dialog modal-sm" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <div class="text-center">
                                        <a href='suvisjt.php?pag=del-sisdamweb&id=<?php echo $editar_sinan_suvis['id']; ?>&sinan=<?php echo $editar_sinan_suvis['sinan']; ?>&agravo=<?php echo $editar_sinan_suvis['agravo']; ?>&nome=<?php echo $editar_sinan_suvis['nome']; ?>&form=sv2'>
