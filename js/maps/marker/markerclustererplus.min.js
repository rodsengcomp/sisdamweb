        ...
        i(r, [
              ...
              (this.div_ = document.createElement("div")),
                ...
                google.maps.event.addDomListener(
                  ...
                  function (n) {
                    if (((e = !1), !t)) {
                      if (
                        (google.maps.event.trigger(s, "click", i.cluster_),
            ...
            value: function () {
              if (this.div_) {
                ...
                if (this.cluster_.getMarkerClusterer().getEnableRetinaIcons())
                  n = "width: "
                    .concat(this.width_, "px; height: ")
                    .concat(this.height_, "px");
                else {
                  var r = -1 * s,
                    a = -1 * i + this.width_,
                    o = -1 * s + this.height_,
                ...
                var u = [
                  ...
                  h = [
                    "position: absolute",
                    "top: ".concat(this.anchorText_[0], "px"),
                    "left: ".concat(this.anchorText_[1], "px"),
                    "color: ".concat(this.textColor_),
                    "font-size: ".concat(this.textSize_, "px"),
                    "font-family: ".concat(this.fontFamily_),
                    "font-weight: ".concat(this.fontWeight_),
                    "font-style: ".concat(this.fontStyle_),
                    "text-decoration: ".concat(this.textDecoration_),
                    "text-align: center",
                    "width: ".concat(this.width_, "px"),
                    "line-height: ".concat(this.height_, "px"),
                  ].join(";");
                (this.div_.innerHTML = "\n<img alt='"
                  .concat(this.sums_.text, '\' aria-hidden="true" src="')
                  .concat(this.url_, '" style="')
                  .concat(u, '"/>\n<div aria-label="')
                  .concat(e, '" tabindex="0" style="')
          ...
          },
          {
            ...
            value: function (e) {
              ...
              return (
                (t.x = Math.floor(t.x - this.anchorIcon_[1])),
              ...
              if (this.center_) {
                if (this.averageCenter_) {
                  var t = this.markers_.length + 1,
                    i =
                      (this.center_.lat() * (t - 1) + e.getPosition().lat()) /
                      t,
                    s =
                      (this.center_.lng() * (t - 1) + e.getPosition().lng()) /
                      t;
          ...
          [
                    ...
                    google.maps.event.addListener(
                      ...
                      function () {
                        var t = e.getMap(),
                          ...
                          s = Math.min(
                            t.maxZoom || 100,
                            t.mapTypes[t.getMapTypeId()].maxZoom
                          ),
                          n = Math.min(Math.max(e.getMap().getZoom(), i), s);
                        e.prevZoom_ != n &&
                          ((e.prevZoom_ = n), e.resetViewport_(!1));
                      }
                    ),
                    google.maps.event.addListener(
                      this.getMap(),
              ...
              value: function () {
                if (!(this.styles_.length > 0))
                  for (var e = 0; e < this.imageSizes_.length; e++) {
                    ...
                    this.styles_.push({
                      url:
                        this.imagePath_ + (e + 1) + "." + this.imageExtension_,
                      height: t,
                      width: t,
                    });
                  }
            ...
            },
            {
              ...
              value: function () {
                for (
                  ...
                  (!e[i].getVisible() && this.getIgnoreHidden()) ||
            ...
            },
            {
              ...
              value: function (e) {
                ...
                return (
                  -1 !== t && (e.setMap(null), this.markers_.splice(t, 1), !0)
                );
              },
            },
            {
            ...
            },
            {
              ...
              value: function (e) {
                for (
                  var t = 4e4, i = null, s = 0;
                  s < this.clusters_.length;
                  s++
                ) {
                ...
                if (this.ready_) {
                  ...
                  for (
                    var s = this.getExtendedBounds(i),
                      n = Math.min(e + this.batchSize_, this.markers_.length),
                      r = e;
                    r < n;
                    r++
                  ) {
                    ...
                    !a.isAdded &&
                      this.isMarkerInBounds_(a, s) &&
                      (!this.ignoreHidden_ ||
                        (this.ignoreHidden_ && a.getVisible())) &&
