...
$(document).ready(function() {
    $('#list-memo').DataTable({
        ...
        processing: true,
        serverside: true,
        ajax: 'form-system/list/proc-list-system/list-memo.php',
        ...
        "aoColumnDefs": [
            ...
            },
            {
                ...
                "mRender": function (data, type, full) { //aqui é uma funçãozinha para pegar os ids
                    return '<a href="suvisjt.php?pag=edit-memo-oficio&id=' + full[0] + '"><button type="button" class="btn btn-warning btn-circle"><span class="glyphicon glyphicon-pencil"></button></a>';
                }
            }
        ]
    });
